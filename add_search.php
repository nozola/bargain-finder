...
if (!empty($_POST)) {
  ...
  $add_search_query = "INSERT INTO genealogy.classifieds_searches (`ID`, `KEYWORD`, `EMAIL`, `ZIP`, `MILES`, `PRICE_LOW`, `PRICE_HIGH`, `HIGHLIGHT`, `REFRESH_RATE`, `DATE_STARTED`) VALUES (NULL, '$keyword', '$email', '$zip', '$miles', '$priceLow', '$priceHigh', '$highlights', '$refreshRate', '$dateStarted')";
    ...
    <div id="container">
      <div>
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
          ...
          <div class="input-container">
            <label for="highlights">Highlights (separate words with a comma)</label>
